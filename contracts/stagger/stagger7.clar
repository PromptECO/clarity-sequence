...
(define-private (range-integer-integer
 ...
 (begin
  ...
  (assert- (and (<= -1 hi) (<= hi 125)) "Out of bounds: hi")
  (let ((d (- hi lo)))
   (fold asc-list
...
(define-private (for-step-1-integer-list-integer-integer
 ...
 (begin
  ...
  (assert- (and (<= 0 g) (<= g 125)) "Out of bounds: g")
...
(define-private (repeat127-integer
                 (x int))
 (begin
  (assert- (and (<= 0 x) (<= x 125)) "Out of bounds: x")
  (list
   x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x
   x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x
   x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x
...
(define-private (for-step-integer-integer-list-integer
                 (g int)
                 (n int)
                 (seq (list 127 int))
                 (step int))
 (begin
  ...
  (map unwrap-panic-
   (filter is-some-
    (let ((i (range-1-integer-integer 0 (- n 1))))
     (map for-step-1-integer-list-integer-integer i
      (repeat127-list seq)
      (repeat127-integer g)
      (repeat127-integer1 step)))))))

(define-private (repeat126-integer
                 (x int))
 (begin
  (assert- (and (<= 0 x) (<= x 127)) "Out of bounds: x")
  (list
...
(define-private (stagger-list
 ...
 (begin
  (assert- (and (<= 0 n) (<= n 127)) "Out of bounds: n")
  (assert- (and (<= 0 step) (<= step 127)) "Out of bounds: step")
  (let ((g (range-integer-integer 0 (- (/ (- (to-int (len seq)) 1)
...
(define-private (for-step-integer-integer-list-integer1
                 (g int)
                 (n int)
                 (seq (list 127 uint))
                 (step int))
...
(define-private (repeat126-list1
                 (x (list 127 uint)))
 (list
  x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x
  x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x
...
(define-private (for-step-integer-integer-list-integer2
                 (g int)
                 (n int)
                 (seq (list 127 bool))
                 (step int))
...
(define-private (repeat126-list2
                 (x (list 127 bool)))
 (list
  x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x
  x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x
...
(define-private (for-step-integer-integer-buffer-integer
                 (g int)
                 (n int)
                 (seq (buff 127))
                 (step int))
...
(define-private (repeat126-buffer
                 (x (buff 127)))
 (list
  x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x
  x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x
...
(define-private (for-step-integer-integer-string-integer
                 (g int)
                 (n int)
                 (seq (string-utf8 127))
                 (step int))
...
(define-private (repeat126-string
                 (x (string-utf8 127)))
 (list
  x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x
  x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x
...
(define-private (stagger-string1
                 (n int)
                 (step int)
                 (seq (string-utf8 127)))
 (begin
...
(define-private (for-step-integer-integer-string-integer1
                 (g int)
                 (n int)
                 (seq (string-ascii 127))
                 (step int))
...
(define-private (repeat126-string1
                 (x (string-ascii 127)))
 (list
  x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x
  x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x
...
(define-private (stagger-string2
                 (n int)
                 (step int)
                 (seq (string-ascii 127)))
 (begin
